...
void initialize() {
  ...
  chassis.opcontrol_curve_default_set(1.8, 1.6);  // Defaults for curve. If using tank, only the first parameter is used. (Comment this line out if you have an SD card!)
  ...
  ez::as::auton_selector.autons_add({
      ...
      {"Tune ABS Auton\n\nTune the absolute auton", tune_abs_auton},
